% README: code for making Figures S10, S11, S16, and S17
...
%% Repeat with original Briggs parameterization

% external recruitment sets
extCs = [0.001, 0.001, 0, 0];
extMs = [0.0001, 0, 0.0001, 0];
...
save('code output/FigS10S11S16S17.mat','CupsB', 'CmidsB', 'ClowsB', 'MupsB', ...
    'MmidsB', 'MlowsB', 'fsetB', 'bstartB', 'bendB', 'fset21B', 'CmeansB', ...
    'MmeansB', 'CupsB2', 'CmidsB2', 'ClowsB2', 'MupsB2', ...
    'MmidsB2', 'MlowsB2', 'fsetB2', 'bstartB2', 'bendB2', 'fset21B2', 'CmeansB2', ...
    'MmeansB2','CupsM', 'CmidsM', 'ClowsM', 'MupsM', ...
