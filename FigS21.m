% README: repeating figure 1 for scenario in which there is no local
% herbivore growth, only external recruitment
...
taxisM = 0; 
taxisC = -1; % taxis rate toward coral
taxisT = 0;
...
hold on
plot(fset, Mlows,'Color', Mcol, "LineStyle","-", 'LineWidth', 2.5) %Cups(:, ploti)
text(0.15, 0.75, 'Bistable', 'Color', 'black','FontSize', 16)
plot(fset, Mups,'Color', Mcol, "LineStyle","-", 'LineWidth', 2.5)
plot(fset, Mmids,'Color', Mcol, "LineStyle","--", 'LineWidth', 2.5) % unstable
...
text(fset21(plotj)-0.002, Mmeans(plotj) + 0.03, 'f = 0.096', 'Color', fcol,'FontSize', 14)
plotj = fpts(2); % f = 0.1005
plot(fset21(plotj), Mmeans(plotj), '.','MarkerSize',30,'Color', Mcol)
plot(fset21(plotj), Mmeans(plotj), 'o','MarkerSize',8,'Color', fcol, 'LineWidth',2.5)
text(fset21(plotj)-0.014, Mmeans(plotj) + 0.035, 'f = 0.115', 'Color', fcol,'FontSize', 14)
plotj = fpts(3); % f = 0.1089
plot(fset21(plotj), Mmeans(plotj), '.','MarkerSize',30,'Color', Mcol)
plot(fset21(plotj), Mmeans(plotj), 'o','MarkerSize',8,'Color', fcol, 'LineWidth',2.5)
text(fset21(plotj)-0.014, Mmeans(plotj) + 0.03, 'f = 0.134', 'Color', fcol,'FontSize', 14)
plotj = fpts(4); % f = 0.1174
plot(fset21(plotj), Mmeans(plotj), '.','MarkerSize',30,'Color', Mcol)
plot(fset21(plotj), Mmeans(plotj), 'o','MarkerSize',8,'Color', fcol, 'LineWidth',2.5)
%text(fset21(plotj)+0.0013, Mmeans(plotj) - 0.025, 'f = 0.133', 'Color', fcol,'FontSize', 14)
text(fset21(plotj)-0.009, Mmeans(plotj) + 0.042, 'f = 0.147', 'Color', fcol,'FontSize', 14)
hold off
hold on
% make legend
...
text(-90, 1.75,'f = 0.147','FontSize',14, 'Color', fcol)
ylim([-0.01 2])
...
plot(xset(b1i:b2i),Cruns(end, b1i:b2i, plotj), 'LineWidth',2, 'Color', Ccol)
text(-90, 1.75,'f = 0.134','FontSize',14, 'Color', fcol)
ylim([-0.01 2])
hold on
plot(xset(b1i:b2i),Mruns(end, b1i:b2i, plotj), 'LineWidth',2, 'Color', Mcol)
hold off
...
plot(xset(b1i:b2i),Cruns(end, b1i:b2i, plotj), 'LineWidth',2, 'Color', Ccol)
text(-90, 1.75,'f = 0.115','FontSize',14, 'Color', fcol)
ylim([-0.01 2])
hold on
plot(xset(b1i:b2i),Mruns(end, b1i:b2i, plotj), 'LineWidth',2, 'Color', Mcol)
hold off
...
plot(xset(b1i:b2i),Cruns(end, b1i:b2i, plotj), 'LineWidth',2, 'Color', Ccol)
text(-90, 1.75,'f = 0.096','FontSize',14, 'Color', fcol)
ylim([-0.01 2])
hold on
plot(xset(b1i:b2i),Mruns(end, b1i:b2i, plotj), 'LineWidth',2, 'Color', Mcol)
hold off
