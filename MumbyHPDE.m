...
function[sol] = MumbyHPDE(r,a,gamma,gz, rH, dH, f,d,alpha, beta, diff,taxisM,taxisC, taxisT, ...
    diric,x,t,initC,Clow, Chigh, Mlow, Mhigh, rnsize, ampC0, ampM0, period0,icchoice, phiH)
...
%System of PDEs describing population dynamics
    function [c,g,s] = pdefcn(xi,t,y,DyDx)
        ...
        %g = [diff(1)*DyDx(1),diff(2)*DyDx(2),diff(3)*DyDx(3)+taxisM*y(3)*DyDx(1)+taxisC*y(3)*DyDx(2)]'; % things that get differentiated w/r/t space
        ...
        M = a*y(1)*y(2)-gz*y(3)*y(1)/(1-y(2))+gamma*y(1)*(1-y(1)-y(2)) + alpha*(1-y(1)-y(2)); % macroalgae
        %M = a*y(1)*y(2)-gz*y(3)*y(1)+gamma*y(1)*(1-y(1)-y(2)) + alpha*(1-y(1)-y(2)); % macroalgae
