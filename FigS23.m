% README: repeating figure 1 for scenario in which total herbivore
...
fpts = [2+2, 6+2, 10+2, 17+2]; % elements of fset21 to highlight in the figure
...
text(fset21(plotj)-0.002, Mmeans(plotj) + 0.03, 'f = 0.126', 'Color', fcol,'FontSize', 14)
plotj = fpts(2); % f = 0.1005
plot(fset21(plotj), Mmeans(plotj), '.','MarkerSize',30,'Color', Mcol)
plot(fset21(plotj), Mmeans(plotj), 'o','MarkerSize',8,'Color', fcol, 'LineWidth',2.5)
text(fset21(plotj)-0.014, Mmeans(plotj) + 0.035, 'f = 0.147', 'Color', fcol,'FontSize', 14)
